                  ...
                  <form onSubmit={editingNote ? handleUpdateNote : handleCreateNote} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-500"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="flex mb-3 gap-2">
                        <input
                          ...
                          className="flex-1 px-3 py-1 border border-gray-300 rounded-md text-sm text-gray-500"
                        />
                        <input
                          type="color"
                          value={newTopicColor}
